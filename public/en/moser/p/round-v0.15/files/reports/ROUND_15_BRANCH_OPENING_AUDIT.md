# Round 15 Candidate and Branch Opening Audit
...
## Excluded Four-Branch Candidate
...
- The four-branch candidate has been excluded;
- A true ascending window exists on the Newton line;
- Selected m=3.2275 after geometric renormalization;
- The fifth branch begins to take over near m=3.228;
- The final margin of the fifth branch is approximately 3.0e-9;
- Interval certificates are not yet available.