...
- Date: 2026-08-18
- Version: v0.1
- Status: Proof-Route Experiment / Continuous-Only Central-Cone Branch
- Previous Round: Round 67 — Log-Viscosity Riccati Tangent / Scattering Derivative
- canonical math delimiters: inline `$...$`; display `$$...$$`

## 0. Why this round shifts to attacking the central cone

Round 67 has already compressed the final viscosity bridge into:
...
If one can very coarsely control

$$
\int_0^{10^{-6}}|\Sigma|,
$$

the final bridge can be completed.

Round 68 takes a step further: it is not even necessary to directly certify the tiny

$$
u_3=-a_3.
$$

The exact recurrence at $n=1$ connects it to two neighboring $O(1)$ quantities, and the sign margins of these two quantities are much larger.
